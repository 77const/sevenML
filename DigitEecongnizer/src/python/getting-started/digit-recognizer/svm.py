...
def trainDRSVM():
    ...
    storeModel(optimalSVMClf, 'datasets/getting-started/digit-recognizer/output/Result_sklearn_SVM.model')
    storeModel(pcaPreData, 'datasets/getting-started/digit-recognizer/output/Result_sklearn_SVM.pcaPreData')
...
def preDRSVM():
    startTime = time.time()
    # 加载模型和数据
    optimalSVMClf = getModel('datasets/getting-started/digit-recognizer/output/Result_sklearn_SVM.model')
    pcaPreData = getModel('datasets/getting-started/digit-recognizer/output/Result_sklearn_SVM.pcaPreData')

    # 结果预测
    testLabel = optimalSVMClf.predict(pcaPreData)
    # print("testLabel = %f" % testscore)
    # 结果的输出
    saveResult(testLabel, 'datasets/getting-started/digit-recognizer/output/Result_sklearn_SVM.csv')
    print("finish!")
    stopTime = time.time()
